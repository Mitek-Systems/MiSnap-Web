...
With TypeScript, `cmd()` infers the shape of `configurationObject` from the command name. Import `MitekCmdParamsFor` from `mitek-science-sdk.js` for explicit annotations (see [Installation — TypeScript](../INSTALLATION.md#typescript-both-options)).
