...
| `aiBasedRtsPayloadSize` | `string` | `"small"` | RTS payload: `"small"` or `"normal"` |
| `aiBasedRtsEncryptionKey` | `AiBasedRtsEncryptionKeyOption` | *(unset)* | `publicKey` (valid base64 DER) and optional `keyId`; omit for SDK default |
...
&#42; Additional AI-based RTS settings: [Capture options — AI-Based RTS](../configuration/capture-options.md#ai-based-rts-real-time-security).
